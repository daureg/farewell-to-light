...
\numprint{22387930} check-ins  from various \glspl{lsbn}.
...
\begin{figure}[hbt]
    ...
    \end{subfigure}
    \caption[Venues clustered by time of check-ins]{.\label{fig:day_cluster}}
\end{figure}
...
\begin{figure}[hbtp]
\includegraphics[width=\textwidth]{density_paris}
