...
%  \usepackage{natbib}
\PassOptionsToPackage{strict}{csquotes}
\usepackage{csquotes}
\usepackage{setspace}
\PassOptionsToPackage{style=alphabetic,maxnames=2,minnames=2,firstinits=true,sorting=nyt,backend=biber,defernumbers=true}{biblatex}
\usepackage{biblatex}
\AtEveryBibitem{
   \clearfield{month}
   \clearfield{series}
...
\usepackage{varioref}
\usepackage{hyperxmp}
\PassOptionsToPackage{hyperfootnotes=false,pdfpagelabels,pdfa}{hyperref}
    \usepackage{hyperref}  % backref linktocpage pagebackref
\pdfcompresslevel=8
\pdfadjustspacing=1
% \PassOptionsToPackage{pdftex}{graphicx}
\usepackage{graphicx}
\graphicspath{{./gfx/}{./mkfigs/}{./experiments/}}
...
\hypersetup{%
	...
	pdfcopyright={Copyright \textcopyright\ 2014, \myName},
	pdflicenseurl={http://creativecommons.org/licenses/by/4.0},
	pdfcontactaddress={17 rue de l'Epine},
	pdfcontactcity={Nantes},
	pdfcontactpostcode={44300},
	pdfcontactcountry={France},
	pdfcontactemail={geraud.lefalher@gmail.com},
	pdfcontacturl={http://daureg.github.io},
	pdflang={en},
}
